  ...
  $(function () {
    ...
    if ($home_page) {
      ...
      function populate_salary_info(salary_info_index) {
        ...
        var prev_active_slider = document.getElementById(
          `salary-slider-${active_slider_index}`
        );
        prev_active_slider.classList.remove("salaries-slideshow-slider-active");

        var new_active_slider = document.getElementById(
          `salary-slider-${salary_info_index}`
        );
      ...
      var $social_media_handle = document.getElementById(
        "social-media-message-handle"
      );
      var $social_media_message = document.getElementById(
        "social-media-message"
      );
      var $social_media_date = document.getElementById(
        "social-media-message-date"
      );
      ...
      var social_media_info = [
        {
          handle: "@RASingStar",
          message:
            "Feel underpaid? Want to see what your peers are making? Then we have just the thing for you. Check out the real agency salaries spreadsheet and wonder no more.",
          date: "1 February 2020",
        },
        {
          handle: "@5tephenBrooks",
          message:
            "An anonymous document created by @cashmeretote provides a snapshot of what salaries in ad agencies look like around the world. See what your peers are making & know your worth.",
          date: "11 January 2020",
        },
        {
          handle: "@ColeWorldNoBlanket",
          message:
            "Times are rough out here in these streets, so make sure that you're making enough to lay on some comfy sheets. Use the RAS spreadsheet to gain some insight as to your true worth",
          date: "28 January 2020",
        },
        {
          handle: "@thatSalaryGuy",
          message:
            "*Testimonial Time!*   I used the information on the real agency salaries' spreadsheet to negotiate my latest raise. Ended up getting paid 15% more PLUS a bonus.",
          date: "14 March 2020",
        },
      ];
      ...
      function change_social_media_display(message_index) {
        ...
        var active_message = document.getElementById(
          `social-media-slider-${active_message_index}`
        );
        active_message.classList.remove("social-media-slider-active");

        var new_message = document.getElementById(
          `social-media-slider-${message_index}`
        );
        new_message.classList.add("social-media-slider-active");
        active_message_index = message_index;
      }

      var $social_media_slider_0 = document.getElementById(
        "social-media-slider-0"
      );
      ...
      var $social_media_slider_1 = document.getElementById(
      ...
      var $social_media_slider_2 = document.getElementById(
        "social-media-slider-2"
      );
      ...
      var $social_media_slider_3 = document.getElementById(
        "social-media-slider-3"
      );
      ...
      for (let i = 0; i < modalTriggers.length; i++) {
        ...
        modalClose[0].addEventListener("click", (e) =>
          handleModalCloseClick(e, modalId)
        );
      }
